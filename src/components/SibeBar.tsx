...
import { FaFileInvoice, FaProductHunt, FaStore } from "react-icons/fa";
import { HiChartPie, HiTicket, HiShoppingBag, HiShoppingCart, HiSupport, HiTable, HiUser, HiIdentification } from 'react-icons/hi';
  ...
  return (
    <div className=" relative h-full">
      <Sidebar aria-label="Sidebar with content separator example" theme={customSideBarTheme}>
        <Sidebar.Items>
          <Sidebar.ItemGroup>
            <Sidebar.Item href="/admin/sale" icon={HiShoppingCart}>
              Sales
            </Sidebar.Item>
          </Sidebar.ItemGroup>
          <Sidebar.ItemGroup>
            ...
            <Sidebar.Item href="/admin/sale-invoice" icon={FaFileInvoice}>
              Sale Invoice
            </Sidebar.Item>
          ...
          <Sidebar.ItemGroup>
            <Sidebar.Item href="/admin/warranty" icon={FaFileInvoice}>
              Warranty
            </Sidebar.Item>
            <Sidebar.Item href="/admin/warranty-invoice" icon={HiShoppingBag}>
              Warranty Invoice
            </Sidebar.Item>
          </Sidebar.ItemGroup>
          <Sidebar.ItemGroup>
...
const customSideBarTheme: CustomFlowbiteTheme['sidebar'] = {
  "root": {
    ...
    "inner": "h-full overflow-y-auto overflow-x-hidden static rounded min-h-screen bg-secondary p-2"
  },
  "collapse": {
  ...
  "item": {
    "base": "flex items-center justify-center rounded-lg p-2 text-base hover:font-semibold font-normal text-white hover:text-secondary hover:bg-primary dark:text-white dark:hover:bg-gray-700",
