...
export default function OperationStateToast({
    ...
    return (
        <div
            ...
            } max-w-[250px] md:max-w-md w-full min-w[200px] md:min-w-[400px] bg-white shadow-lg border-2 rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5`}
        >
