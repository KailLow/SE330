...
import ImportBillDateFilter from "@/components/ImportBillDateFilter";
            ...
            (
                preData?.map(
                    (value: Revision<ImportBill<ImportProductResponse>>) => ({
                        ...
                        totalProducts: value.revision.importProducts.reduce(
        ...
        <>
            ...
            <div className="w-full mb-8">
                <ImportBillDateFilter
                    onSearch={(start :any, end :any) => onDateFilter(start, end)}
                />
            </div>
            <div className=" w-full h-full overflow-auto flex flex-col-reverse lg:flex-row gap-5">
                <DataTable
                    ...
                    pick={{
                        ...
                        totalProducts: {
                            title: "Quantity",
                            mapper: (value?: number) => `${value || 0} items`,
                        },
                    }}
                />
                {children}
